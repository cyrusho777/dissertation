...
// MultiResourceArgs defines the parameters for MultiResource plugin.
type MultiResourceArgs struct {
	metav1.TypeMeta

	// Alpha is a weight factor between 0 and 1 to balance between spreading and packing
